...
function vt(e, t, n = void 0) {
  ...
  return function() {
    const c = Date.now();
    !u && n.leading === false && (u = c);
    const f = t - (c - u);
    return r = this, i = arguments, f <= 0 || f > t ? (l && (clearTimeout(l), l = null), u = c, a = e.apply(r, i), l === null && (r = i = null)) : !l && n.trailing !== false && (l = setTimeout(d, f)), a;
  };
}
...
var m = class _m {
  ...
  constructor({ data: t, config: n, api: r, readOnly: i, block: a }) {
    ...
    this.api = r, this.readOnly = i, this._quotePlaceholder = n.quotePlaceholder || _m.DEFAULT_QUOTE_PLACEHOLDER, this._captionPlaceholder = n.captionPlaceholder || _m.DEFAULT_CAPTION_PLACEHOLDER, this._data = {
      text: t.text || "",
      caption: t.caption || "",
