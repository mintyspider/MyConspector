...
Этот проект создан исключительно в образовательных целях. Мы не гарантируем полноту и абсолютную точность материалов.

Если заметили ошибку или хотите внести дополнения — создайте [issue](https://github.com/mintyspider/MyConspector/issues/new).
:::
